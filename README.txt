...
Thank you for using the Hero Me Builder! 

Most parts are interchangeable, however some are too unique to be compatible with the Builder. For example, the Anycubic Chiron uses a gantry adapter that attaches to the probe mounts instead of the back of the base.
A lot of spacers and niche parts are also not compatible with the Builder because they are modeled together in a single stl and cannot be seperated.
